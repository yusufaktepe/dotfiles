...
function M.get()
  ...
  ---@class PluginLspKeys
    ...
    M._keys = {
      ...
      { "gd", function() require("telescope.builtin").lsp_definitions({ reuse_win = true }) end, desc = "Lsp: [G]oto [d]efinition", has = "definition" },
      { "gr", "<cmd>Telescope lsp_references<cr>", desc = "Lsp: [r]eferences" },
      { "gD", vim.lsp.buf.declaration, desc = "Lsp: Goto [D]eclaration" },
      { "gI", function() require("telescope.builtin").lsp_implementations({ reuse_win = true }) end, desc = "Lsp: Goto [I]mplementation" },
      { "gy", function() require("telescope.builtin").lsp_type_definitions({ reuse_win = true }) end, desc = "Lsp: Goto t[y]pe definition" },
