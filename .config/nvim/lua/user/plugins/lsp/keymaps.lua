...
function M.get()
  ...
  ---@class PluginLspKeys
    ...
    M._keys = {
      ...
      { "gt", "<cmd>Telescope lsp_type_definitions<cr>", desc = "Lsp: Goto [t]ype definition" },
      ...
      { "<leader>cf", format, desc = "Lsp: [F]ormat Document", has = "documentFormatting" },
      { "<leader>cf", format, desc = "Lsp: [F]ormat Range", mode = "v", has = "documentRangeFormatting" },
    }
